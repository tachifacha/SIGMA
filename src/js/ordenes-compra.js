document.addEventListener('DOMContentLoaded', function() {
    ...
    function agregarFila() {
        ...
        selectMaterial.addEventListener('change', function() {
            ...
            fila.querySelector('.precio-cell').textContent = '$' + precio.toLocaleString('es-AR');
    ...
    function recalcularFila(fila) {
        ...
        fila.querySelector('.subtotal-cell').textContent = '$' + subtotal.toLocaleString('es-AR', { minimumFractionDigits: 2 });
        calcularTotal();
    }
    ...
    function calcularTotal() {
        ...
        document.getElementById('totalOrden').innerHTML = '<strong>$' + total.toLocaleString('es-AR', { minimumFractionDigits: 2 }) + '</strong>';
    }
